...
![OT 生命周期](assets/axi-outstanding/01-ot-lifecycle.png)
...
![ot_count 方程](assets/axi-outstanding/02-ot-counter.png)
...
![阈值与 backpressure](assets/axi-outstanding/03-threshold-backpressure.png)
...
![延迟 response 导致 OT 累积](assets/axi-outstanding/04-long-response-delay.png)
...
![读写 OT 与 ID 匹配](assets/axi-outstanding/05-read-write-id.png)
...
![同周期计数保持](assets/axi-outstanding/06-same-cycle-alloc-retire.png)
...
![reset 与 flush 验证](assets/axi-outstanding/07-reset-flush.png)
