...
```
PCIe Device
  +-- PF0 (mfiov_spt=1)   支持 MFIOV，有 VF bank
  +-- PF1
  +-- [VF bank]            最多 N 个 VF 槽位
```
...
PCIe Device
  +-- PF0
  +-- PF1
  +-- F2   (实际是 PF0 的 VF 槽位 0，mfiov_func=1, mfiov_pf_index=0)
...
- 获取 SRIOV VF 数量的接口返回 0：MFIOV 模式下没有标准 SR-IOV VF
